      ...
      <div class="dash-hero">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;">
          <div style="flex:1;">
            ...
            <div style="font-size:10px;color:var(--text-dim);margin-top:4px;">🏆 Mục tiêu cuối: <b style="color:var(--gold);">GM 2500</b> | ${getDaysUntilGM()} ngày</div>
          </div>
        ...
        <div style="display:flex;gap:10px;margin-top:10px;">
          <div class="dash-countdown" style="flex:1;">
            <span class="dash-countdown-num">${daysLeft}</span>
            <span class="dash-countdown-label">ngày<br>ASEAN 2026 🇸🇬</span>
          </div>
          <div class="dash-countdown" style="flex:1;background:linear-gradient(135deg, rgba(255,214,0,0.08), rgba(255,214,0,0.02));border:1px solid rgba(255,214,0,0.15);">
            <span class="dash-countdown-num" style="color:var(--gold);">${getDaysUntilGM()}</span>
            <span class="dash-countdown-label">ngày<br>GM 2500 👑</span>
          </div>
        </div>
      </div>
    `;
